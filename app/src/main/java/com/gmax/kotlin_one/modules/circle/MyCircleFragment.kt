...
import com.gmax.kotlin_one.adapter.ImgAdapter
...
class MyCircleFragment : BaseBindingFragment<FragmentMySmartBinding>(),EachCircleContract.View, CircleContract.View, CodesContract.View, OnHolderListener<CircleBean, CircleAdapter<CircleBean>.MyRefrashHolder>, CommentListener.MyItemClickListener {
    ...
    internal var methodType = MethodType.METHOD_TYPE_SINGLE_CIRCLES
    ...
    override fun initView() {
        ...
        circleAdapter.mItemClickListener = this
    }
...
//                val photoAdapter = CirclePhotoAdapter(context, selectedPhotos)
                val photoAdapter = ImgAdapter(selectedPhotos, activity)
...
//
//
//                        Log.e("tesyimage",selectedPhotos[position]+"-------tesyimage---"+position)
//                    }
//                })
...
//            startActivity(intent)
    ...
    override fun onItemClick(view: View, position: Int) {
        currentPosition = position
        if (circleBeans[position] != null) {
            circleid = circleBeans[position].circleid

//            val intent = Intent(activity, EarchCircleActivity::class.java)
//            intent.putExtra("innerCircleBean",circleBeans[position])
//            intent.putExtra("circle_tag", tag)
//            startActivity(intent)
        }
    }
    ...
    override fun getMethod(): String {
        var method = ""
        when (methodType) {
            MethodType.METHOD_TYPE_SINGLE_CIRCLES -> method = MethodConstant.GET_SINGLE_FRIEND_CIRCLES
    ...
    fun getParaMap(): Map<String, String> {
        ...
        when (methodType) {
            MethodType.METHOD_TYPE_SINGLE_CIRCLES -> {
